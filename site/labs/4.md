...
Рекурентне співвідношення виконується допоки, поки результат більший за точність вимірювання. У завданні задаються дві умови, які потрібно виконати. Користувач вводить початкове та кінцеві значення `х`, точність та крок. У консоль виводиться таблиця з результатами обчислень - для бібліотечної функції, для самостійної та похибкою обчислення. 
